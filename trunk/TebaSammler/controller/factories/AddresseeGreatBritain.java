...
/**This class creates a displayed form of a british addressee address.
 * 
 * @author Antje Huber
 *
 */
public class AddresseeGreatBritain extends Address {
    
    public AddresseeGreatBritain(ItemAddress address, Titles titlesAddressee,
