...
/**This command sets a new addresser.
 * 
 * @author Antje Huber
 *
 */
public class CommandSetAddresser extends Command {
    
    private ItemAddress addresser;
    
    public CommandSetAddresser(ItemAddress addresser) {
