...
/**This command sets a new addressee.
 * 
 * @author Antje Huber
 *
 */
public class CommandSetAddressee extends Command {
    
    private ItemAddress addressee;
    
    public CommandSetAddressee(ItemAddress addressee) {
