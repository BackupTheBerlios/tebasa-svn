...
import controller.commands.CommandPrintResult;

/**ActionListener for printing a document.
 * 
 * @author Antje Huber
 *
 */
public class ActionListenerPrint implements ActionListener {
    ...
    public ActionListenerPrint(InterfaceController controller,
    ...
    public void actionPerformed(ActionEvent e) {
        controller.commitCommand(new CommandPrintResult(resultOperations));        
    }
}
